...
// import { EveesModule, EveesEthereum, EveesHttp, EveesRemote } from '@uprtcl/evees';
...
//   private evees = new EveesModule([this.ethEvees as EveesRemote, this.httpEvees], this.remotesConfig);
